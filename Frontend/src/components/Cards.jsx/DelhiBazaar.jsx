...
const DelhiBazaarCard = () => {
 ...
 const [showChart, setShowChart] = useState(false);
  ...
  if (showChart) {
    return <ResultChart marketName="DELHI BAZAAR" onClose={() => setShowChart(false)} />;
  }
  ...
  return (
    <div className="w-full max-w-md mx-auto">
      ...
      >
        {/* Header */}
        <div onClick={() => setOpen(true)} className="cursor-pointer bg-yellow-500 border-blue-950 text-black font-bold text-center py-2">
      DELHI BAZAAR
        </div>
        ...
        <div onClick={() => setOpen(true)} className="cursor-pointer flex flex-col items-center justify-center gap-2 py-4 px-3">
          ...
          <div className="flex justify-between text-sm text-gray-700 w-full mt-3">
            <p>
              <span className="font-medium">Open:</span> 08:00 PM
            </p>
            <p>
              <span className="font-medium">Close:</span> 06:40 PM
            </p>
          </div>
        </div>
      </div>
...
export default DelhiBazaarCard;
