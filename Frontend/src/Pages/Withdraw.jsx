        ...
        <>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex justify-center gap-4">
                <button type="button" onClick={() => setMethod('upi')} className={`px-4 py-2 rounded ${method === 'upi' ? 'bg-blue-600 text-white' : 'bg-gray-500'}`}>UPI</button>
                <button type="button" onClick={() => setMethod('bank')} className={`px-4 py-2 rounded ${method === 'bank' ? 'bg-blue-600 text-white' : 'bg-gray-500'}`}>Bank Transfer</button>
            </div>
